...
// VoteButtons extracted to components/VoteButtons.scala
...
// ViewToggle extracted to components/ViewToggle.scala
...
// InlineEditableTitle extracted to components/InlineEditableTitle.scala

// ErrorBanner extracted to components/ErrorBanner.scala

// Menu, UnscheduledDiscussionsMenu, ActiveDiscussionActionMenu extracted to components/Menus.scala
