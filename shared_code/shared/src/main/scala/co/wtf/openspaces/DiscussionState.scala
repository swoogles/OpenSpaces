  ...
  val timeSlotExamples =
    List(
      DaySlots(
        ...
        List(
          TimeSlotForAllRooms(
            TimeSlot("8:00-8:50", LocalDateTime.parse("2025-06-24T08:00:00")),
            List(Room.king,
                 Room.hawk,
                 Room.artGallery,
                 Room.danceHall,
          ...
          TimeSlotForAllRooms(
            TimeSlot("9:20-10:10", LocalDateTime.parse("2025-06-24T09:20:00")),
            List(Room.king,
                 Room.hawk,
                 Room.artGallery,
                 Room.danceHall,
          ...
          TimeSlotForAllRooms(
            TimeSlot("10:30-11:20", LocalDateTime.parse("2025-06-24T10:30:00")),
            List(Room.king,
                 Room.hawk,
                 Room.artGallery,
                 Room.danceHall,
      ...
      DaySlots(
        ...
        List(
          TimeSlotForAllRooms(
            TimeSlot("8:00-8:50", LocalDateTime.parse("2025-06-25T08:00:00")),
            List(Room.king,
                 Room.hawk,
                 Room.artGallery,
                 Room.danceHall,
          ...
          TimeSlotForAllRooms(
            TimeSlot("9:20-10:10", LocalDateTime.parse("2025-06-25T09:20:00")),
            List(Room.king,
                 Room.hawk,
                 Room.artGallery,
                 Room.danceHall,
          ...
          TimeSlotForAllRooms(
            TimeSlot("10:30-11:20", LocalDateTime.parse("2025-06-25T10:30:00")),
            List(Room.king,
                 Room.hawk,
                 Room.artGallery,
                 Room.danceHall,
      ...
      DaySlots(
        ...
        List(
          TimeSlotForAllRooms(
            TimeSlot("8:00-8:50", LocalDateTime.parse("2025-06-27T08:00:00")),
            List(Room.king,
                 Room.hawk,
                 Room.artGallery,
                 Room.danceHall,
          ...
          TimeSlotForAllRooms(
            TimeSlot("9:20-10:10", LocalDateTime.parse("2025-06-27T09:20:00")),
            List(Room.king,
                 Room.hawk,
                 Room.artGallery,
                 Room.danceHall,
          ...
          TimeSlotForAllRooms(
            TimeSlot("10:30-11:20", LocalDateTime.parse("2025-06-27T10:30:00")),
            List(Room.king,
                 Room.hawk,
                 Room.artGallery,
                 Room.danceHall,
